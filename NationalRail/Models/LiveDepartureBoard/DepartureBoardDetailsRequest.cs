...
namespace NationalRail.Models.LiveDepartureBoard
{
    public class DepartureBoardDetailsRequest
    {
        ...
        [XmlRoot(ElementName = "GetDepBoardWithDetailsRequest", Namespace = "http://thalesgroup.com/RTTI/2016-02-16/ldb/")]
        ...
        public class Body
        {
            public Body()
            {
                GetDepBoardWithDetailsRequest = new GetDepBoardWithDetailsRequest();
            }

            [XmlElement(ElementName = "GetDepBoardWithDetailsRequest", Namespace = "http://thalesgroup.com/RTTI/2016-02-16/ldb/")]
            public GetDepBoardWithDetailsRequest GetDepBoardWithDetailsRequest { get; set; }
        }
