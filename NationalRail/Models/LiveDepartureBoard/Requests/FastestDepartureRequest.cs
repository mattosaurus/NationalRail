...
{
    public class FastestDepartureRequest
    {
        ...
        [XmlRoot(ElementName = "GetFastestDeparturesRequest", Namespace = "http://thalesgroup.com/RTTI/2016-02-16/ldb/")]
        public class GetFastestDeparturesRequest
        {
        ...
        public class Body
        {
            public Body()
            {
                GetFastestDeparturesRequest = new GetFastestDeparturesRequest();
            }

            [XmlElement(ElementName = "GetFastestDeparturesRequest", Namespace = "http://thalesgroup.com/RTTI/2016-02-16/ldb/")]
            public GetFastestDeparturesRequest GetFastestDeparturesRequest { get; set; }
        }
