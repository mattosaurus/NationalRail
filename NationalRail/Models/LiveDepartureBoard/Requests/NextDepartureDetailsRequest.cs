...
{
    public class NextDepartureDetailsRequest
    {
        ...
        public class GetNextDeparturesWithDetailsRequest
        {
        ...
        public class Body
        {
            public Body()
            {
                GetNextDeparturesWithDetailsRequest = new GetNextDeparturesWithDetailsRequest();
            }

            [XmlElement(ElementName = "GetNextDeparturesWithDetailsRequest", Namespace = "http://thalesgroup.com/RTTI/2016-02-16/ldb/")]
            public GetNextDeparturesWithDetailsRequest GetNextDeparturesWithDetailsRequest { get; set; }
        }
