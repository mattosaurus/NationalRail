...
{
    public class ArrivalBoardDetailsRequest
    {
        ...
        [XmlRoot(ElementName = "GetArrBoardWithDetailsRequest", Namespace = "http://thalesgroup.com/RTTI/2016-02-16/ldb/")]
        public class GetArrBoardWithDetailsRequest
        {
        ...
        public class Body
        {
            public Body()
            {
                GetArrBoardWithDetailsRequest = new GetArrBoardWithDetailsRequest();
            }

            [XmlElement(ElementName = "GetArrBoardWithDetailsRequest", Namespace = "http://thalesgroup.com/RTTI/2016-02-16/ldb/")]
            public GetArrBoardWithDetailsRequest GetArrBoardWithDetailsRequest { get; set; }
        }
